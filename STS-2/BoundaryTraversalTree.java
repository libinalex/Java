...
public class BoundaryTraversalTree {
    ...
    static void addLeftNodes(Node root, ArrayList<Integer> al) {
        Node node = root.left;
        while (node != null) {
            if(!isLeaf(node))
                al.add(node.data);
    ...
    static void addLeafNodes(Node root, ArrayList<Integer> al) {
        inorderTraversal(root, al);
    }

    static void addRightNodes(Node root, ArrayList<Integer> al) {
    ...
    public static void boundaryTraversal(Node root) {
        ...
        al.add(root.data);
        addLeftNodes(root, al);
        addLeafNodes(root, al);
        addRightNodes(root, al);
