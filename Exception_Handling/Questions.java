/*
1. Devise a Java program to illustrate any three types of run time exceptions. Print the 
errors using exception variable, StackTrace, toString, getMessage
*/

/*
2. Devise a Java program to withdraw the amount from the bank account. While withdraw, 
the program should check the amount in the account. If the amount in the account is > 
than the amount entered then raise the exception “Amount withdraw failure” else 
withdraw the amount.
*/

/*
3. Create an abstract class 'Parent' with a method 'message'. It has two subclasses each 
...
/*
5. We have to calculate the area of a rectangle, a square and a circle. Create an abstract 
